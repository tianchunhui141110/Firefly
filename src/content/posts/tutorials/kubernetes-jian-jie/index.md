...
## kubelet[](https://docs.youdianzhishi.com/k8s/basic/overview/#kubelet)
...
## kube-proxy[](https://docs.youdianzhishi.com/k8s/basic/overview/#kube-proxy)
...
## kubectl[](https://docs.youdianzhishi.com/k8s/basic/overview/#kubectl)

Kubectl 是 Kubernetes 的集群管理命令行客户端工具集。通过 Kubectl 命令对 API Server 进行操作，API Server 响应并返回对应的命令结果，从而达到对 Kubernetes 集群的管理

# 核心资源对象[](https://docs.youdianzhishi.com/k8s/basic/overview/#核心资源对象)
...
## Pod[](https://docs.youdianzhishi.com/k8s/basic/overview/#pod)
...
## Label[](https://docs.youdianzhishi.com/k8s/basic/overview/#label)
...
## Namespace[](https://docs.youdianzhishi.com/k8s/basic/overview/#namespace)
...
## Deployment[](https://docs.youdianzhishi.com/k8s/basic/overview/#deployment)
...
## Service[](https://docs.youdianzhishi.com/k8s/basic/overview/#service)
