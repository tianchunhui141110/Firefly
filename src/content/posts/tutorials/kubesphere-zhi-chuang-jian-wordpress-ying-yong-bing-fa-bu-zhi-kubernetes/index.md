...
### [官网链接](https://kubesphere.io/docs/zh-CN/quick-start/wordpress-deployment/#wordpress-%E7%AE%80%E4%BB%8B)
...
![img](./images/20191027200444.png)

#### 1.创建秘钥

1. 创建MySQL秘钥
   - 以项目普通用户 project-regular 登录 KubeSphere，在当前项目下左侧菜单栏的 配置中心 选择 密钥，点击 创建。

   ![img](./images/20191027202848.png)
   - 填写密钥的基本信息，完成后点击 **下一步**。
   ...
   ![img](./images/20191027203044.png)

2. 创建WordPress 密钥

   同上，创建一个 WordPress 密钥，Data 键值对填写 `WORDPRESS_DB_PASSWORD`和 `123456`。此时两个密钥都创建完成。 ![img](./images/20191027203325.png)

#### 3.创建存储卷

- `(只事例wordpress mysql同理)`
