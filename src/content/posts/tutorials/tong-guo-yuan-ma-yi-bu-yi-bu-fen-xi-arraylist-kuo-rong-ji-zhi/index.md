---
title: "通过源码一步一步分析 ArrayList 扩容机制"
published: 2020-07-08
description: "一 先从 ArrayList 的构造函数说起"
tags: ["ArrayList"]
category: "Java"
draft: false
lang: zh_CN
...
public class ArraycopyTest {
	...
	public static void main(String[] args) {
		...
		a[2]=99;
		for (int i = 0; i 3.2 `Arrays.copyOf()`方法
...
public class EnsureCapacityTest {
	public static void main(String[] args) {
        ...
        for (int i = 0; i https://github.com/Snailclimb/JavaGuide/blob/master/docs/java/collection/ArrayList-Grow.md
